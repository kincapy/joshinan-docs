...
ビザ更新は入管報告の中でも特に重要なトピック。学校のランク（＝適正校認定）に直結するため。

- 適正校の認定基準のひとつに**ビザ更新不許可率**がある
- 問題在籍学生者数のカウント基準に「在留期間更新が不許可となった者」が含まれる
- 不許可率が高いと適正校認定が外れ、提出書類が大幅に増え募集業務に支障をきたす

::: warning 提出書類の準備が鍵
ビザ更新の許可率を高めるには、以下の書類を確実に収集・管理することが重要：
- 学生の通帳の写し
- 学生の給与明細
- 各種申告書
- 入管所定の書式
